...
void IMU_update(){
    ...
    IMU_Data.aAz=atan2(imu963ra_acc_z,imu963ra_acc_x)/(PI/180);
    ...
    //一阶互补滤波
    IMU_Data.Rol=FCOF(IMU_Data.aAx,IMU_Data.gGx,&IMU_Data.lastRol);
    IMU_Data.Pit=FCOF(IMU_Data.aAy,IMU_Data.gGy,&IMU_Data.lastPit);
    IMU_Data.Yaw=FCOF(IMU_Data.aAz,IMU_Data.gGz,&IMU_Data.lastYaw);
}
